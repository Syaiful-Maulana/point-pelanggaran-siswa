...
Lightweight customizable cross-browser jQuery datepicker in English, built with es5 and css-flexbox. Works in all modern desktop and mobile browsers (tested on Android 4.4+ and iOS8+).
