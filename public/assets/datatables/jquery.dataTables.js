...
(function (factory) {
    ...
    var DataTable = function (selector, options) {
         ...
         * function. With this function you can have a DataTables table go to the Selanjutnya,
         * Sebelumnya, first or last pages.
         *  @param {string|int} mAction Paging action to take: "first", "Sebelumnya", "Selanjutnya" or "last"
         ...
         *    $(document).ready(function() {
         *      var oTable = $('#example').dataTable();
         *      oTable.fnPageChange( 'Selanjutnya' );
         *    } );
         */
        ...
        for (var fn in DataTable.ext.internal) {
            if (fn) {
                this[fn] = _fSelanjutnyaernApiFunc(fn);
            }
        }
        ...
        this.each(function () {
            ...
            var oInit =
                len > 1 // optimisation for single table case
                    ? _fSelanjutnyaend(o, options, true)
                    : options;
            ...
            for (i = 0, iLen = allSettings.length; i < iLen; i++) {
                ...
                /* If the element we are initialising has the same ID as a table which was Sebelumnyaly
            ...
            oInit = _fSelanjutnyaend($.extend(true, {}, defaults), oInit);
    ...
    DataTable.util = {
        ...
        get: function (source) {
            if ($.isPlainObject(source)) {
                 ...
                 * nested object so we loop over the data for each level to get the Selanjutnya
    ...
    function _fnLanguageCompat(lang) {
        ...
        if (lang) {
            ...
            if (
                !lang.sEmptyTable &&
                zeroRecords &&
                defaults.sEmptyTable === "Tidak Ada Data Yang Tersimpan"
            ) {
     ...
     * the cached data is Selanjutnya requested. Also update from the data source object.
     *
     * @param {object} settings DataTables settings object
    ...
    function _fnReDraw(settings, holdPosition) {
        ...
        if (filter) {
            _fnFilterComplete(settings, settings.oSebelumnyaSearch);
        } else {
    ...
    function _fnAddOptionsHtml(oSettings) {
        ...
        oSettings.nTableReinsertBefore = oSettings.nTable.SelanjutnyaSibling;

        /* Loop over the user set positioning and place the elements as needed */
        var aDom = oSettings.sDom.split("");
        var featureNode, cOption, nNewNode, cSelanjutnya, sAttr, j;
        for (var i = 0; i < aDom.length; i++) {
            ...
            if (cOption == "<") {
                ...
                cSelanjutnya = aDom[i + 1];
                if (cSelanjutnya == "'" || cSelanjutnya == '"') {
                    sAttr = "";
                    j = 2;
                    while (aDom[i + j] != cSelanjutnya) {
                        sAttr += aDom[i + j];
                        j++;
                    }
    ...
    function _fnDetectHeader(aLayout, nThead) {
        ...
        for (i = 0, iLen = nTrs.length; i < iLen; i++) {
            ...
            while (nCell) {
                ...
                nCell = nCell.SelanjutnyaSibling;
            }
        }
    }
    ...
    function _fnBuildAjax(oSettings, data, fn) {
        ...
        if (oSettings.fnServerData) {
            ...
            // Restore for Selanjutnya time around
            ajax.data = ajaxData;
        }
    }
    ...
    function _fnAjaxParameters(settings) {
        var columns = settings.aoColumns,
            ...
            preSearch = settings.oSebelumnyaSearch,
    ...
    function _fnFeatureHtmlFilter(settings) {
        ...
        var SebelumnyaSearch = settings.oSebelumnyaSearch;
        ...
        var searchFn = function (event) {
            ...
            if (SebelumnyaSearch.return && event.key !== "Enter") {
                return;
            }
            /* Now do the filter */
            if (val != SebelumnyaSearch.sSearch) {
                _fnFilterComplete(settings, {
                    sSearch: val,
                    bRegex: SebelumnyaSearch.bRegex,
                    bSmart: SebelumnyaSearch.bSmart,
                    bCaseInsensitive: SebelumnyaSearch.bCaseInsensitive,
                    return: SebelumnyaSearch.return,
                });
            ...
            if (settings === s) {
                ...
                try {
                    if (jqFilter[0] !== document.activeElement) {
                        jqFilter.val(SebelumnyaSearch.sSearch);
                    }
                } catch (e) {}
            }
        });
    ...
    function _fnFilterComplete(oSettings, oInput, iForce) {
        var oPrevSearch = oSettings.oSebelumnyaSearch;
    ...
    function _fnFilter(settings, input, force, regex, smart, caseInsensitive) {
        ...
        var prevSearch = settings.oSebelumnyaSearch.sSearch;
     ...
     *  @param {object} settings DataTables settings object
     *  @param {string|int} action Paging action to take: "first", "Sebelumnya",
     *    "Selanjutnya" or "last" or page number to jump to (integer)
    ...
    function _fnPageChange(settings, action, redraw) {
        ...
        if (records === 0 || len === -1) {
            ...
            start = 0;
        } else if (action == "Sebelumnya") {
            start = len >= 0 ? start - len : 0;

            if (start < 0) {
                start = 0;
            }
        } else if (action == "Selanjutnya") {
    ...
    function _fnScrollDraw(settings) {
        ...
        // Read all widths in Selanjutnya pass
    ...
    function _fnApplyToChildren(fn, an1, an2) {
        ...
        while (i < iLen) {
            ...
            while (nNode1) {
                ...
                nNode1 = nNode1.SelanjutnyaSibling;
                nNode2 = an2 ? nNode2.SelanjutnyaSibling : null;
            }
    ...
    function _fnSort(oSettings) {
        ...
        if (_fnDataSource(oSettings) != "ssp" && aSort.length !== 0) {
             ...
             * test the Selanjutnya column. If all columns match, then we use a numeric sort on the row
    ...
    function _fnSortListener(settings, colIdx, append, callback) {
        ...
        var asSorting = col.asSorting;
        var SelanjutnyaSortIdx;
        var Selanjutnya = function (a, overflow) {
            var idx = a._idx;
            if (idx === undefined) {
        ...
        if (append && settings.oFeatures.bSortMulti) {
            ...
            if (sortIdx !== -1) {
                // Yes, modify the sort
                SelanjutnyaSortIdx = Selanjutnya(sorting[sortIdx], true);

                if (SelanjutnyaSortIdx === null && sorting.length === 1) {
                    SelanjutnyaSortIdx = 0; // can't remove sorting completely
                }

                if (SelanjutnyaSortIdx === null) {
                    sorting.splice(sortIdx, 1);
                } else {
                    sorting[sortIdx][1] = asSorting[SelanjutnyaSortIdx];
                    sorting[sortIdx]._idx = SelanjutnyaSortIdx;
                }
            } else {
            ...
            SelanjutnyaSortIdx = Selanjutnya(sorting[0]);

            sorting.length = 1;
            sorting[0][1] = asSorting[SelanjutnyaSortIdx];
            sorting[0]._idx = SelanjutnyaSortIdx;
        } else {
    ...
    function _fnSaveState(settings) {
        ...
        var state = {
            ...
            search: _fnSearchToCamel(settings.oSebelumnyaSearch),
    ...
    function _fnImplementState(settings, s, callback) {
        ...
        if (s.search !== undefined) {
            $.extend(settings.oSebelumnyaSearch, _fnSearchToHung(s.search));
        }
     ...
     */
    function _fSelanjutnyaend(out, extender, breakRefs) {
        var val;
     ...
     *    * `Selanjutnya` - Jump to the Selanjutnya page
     *    * `Sebelumnya` - Jump to Sebelumnya page
    ...
    _api_register("search()", function (input, regex, smart, caseInsen) {
        ...
        if (input === undefined) {
            // get
            return ctx.length !== 0
                ? ctx[0].oSebelumnyaSearch.sSearch
                : undefined;
        }
        ...
        return this.iterator("table", function (settings) {
            ...
            _fnFilterComplete(
                settings,
                $.extend({}, settings.oSebelumnyaSearch, {
                    sSearch: input + "",
    ...
    _api_registerPlural(
        ...
        function (input, regex, smart, caseInsen) {
            return this.iterator("column", function (settings, column) {
                ...
                _fnFilterComplete(settings, settings.oSebelumnyaSearch, 1);
            });
        }
    );
    ...
    DataTable.models.oColumn = {
         ...
         * Sort it again (click again) and it will move on to the Selanjutnya index.
         * Repeat until loop.
         *  @type array
         */
        asSorting: null,
    ...
    DataTable.defaults = {
         ...
         * the page the display display will match what thy had Sebelumnyaly set up.
         *
         ...
         * (i.e. "Menampilkan 1 to 10 of 57 Data") DataTables will render large numbers
        ...
        oLanguage: {
            ...
            oPaginate: {
                ...
                /**
                 * Text to use for the 'Selanjutnya' pagination button (to take the user to the
                 * Selanjutnya page).
                 *  @type string
                 *  @default Selanjutnya
                 *
                 *  @dtopt Language
                 *  @name DataTable.defaults.language.paginate.Selanjutnya
                 *
                 *  @example
                 *    $(document).ready( function() {
                 *      $('#example').dataTable( {
                ...
                /**
                 * Text to use for the 'Sebelumnya' pagination button (to take the user to
                 * the Sebelumnya page).
                 *  @type string
                 *  @default Sebelumnya
                 *
                 *  @dtopt Language
                 *  @name DataTable.defaults.language.paginate.Sebelumnya
                 *
                 *  @example
                 *    $(document).ready( function() {
                 *      $('#example').dataTable( {
             ...
             *
             *  @type string
             *  @default Menampilkan _START_ to _END_ of _TOTAL_ Data
             *
             *  @dtopt Language
             ...
             *  @type string
             *  @default Menampilkan 0 to 0 of 0 Data
             *
             *  @dtopt Language
         ...
         * * `full` - 'First', 'Sebelumnya', 'Selanjutnya' and 'Last' buttons
         * * `full_numbers` - 'First', 'Sebelumnya', 'Selanjutnya' and 'Last' buttons, plus page numbers
    ...
    DataTable.ext = _ext = {
         ...
         * * `Sebelumnya` - Show Sebelumnya page when activated
         * * `Selanjutnya` - Show Selanjutnya page when activated
         ...
         *
         *  @example
         *    // Show Sebelumnya, Selanjutnya and current page buttons only
         *    $.fn.dataTableExt.oPagination.current = function ( page, pages ) {
         *      return [ 'Sebelumnya', page, 'Selanjutnya' ];
         *    };
         */
        pager: {},
    ...
    $.extend(extPagination, {
        simple: function (page, pages) {
            return ["Sebelumnya", "Selanjutnya"];
        },

        full: function (page, pages) {
            return ["first", "Sebelumnya", "Selanjutnya", "last"];
        },
        ...
        simple_numbers: function (page, pages) {
            return ["Sebelumnya", _numbers(page, pages), "Selanjutnya"];
        },
     ...
     */
    function _fSelanjutnyaernApiFunc(fn) {
        return function () {
            var args = [
    ...
    $.extend(DataTable.ext.internal, {
        _fSelanjutnyaernApiFunc: _fSelanjutnyaernApiFunc,
        ...
        _fSelanjutnyaend: _fSelanjutnyaend,
