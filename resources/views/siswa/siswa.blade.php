                        ...
                        <div class="py-12" >
                            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8" style="margin-left: 30px">
                                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                                    ...
                                    <a href="{{ url('exportExcel1')}}" type="button"  class="btn btn-success mb-4 mt-3" >
...
@section('modal')
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <form action="{{ url('importExcel1')}}" method="POST" id="forms">
                    @csrf
  ...
  <div class="modal fade" id="modal-info" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="siswa.store" method="POST" id="forms">
            @csrf
        <div class="modal-body">
            <div class="form-group">
